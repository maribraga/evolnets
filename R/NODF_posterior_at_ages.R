...
#'
#' @description Calculate z-scores for nestedness (NODF) for each MCMC sample at time points in the past based on null networks where all interactions have the same probability. By calculating z-scores, we can compare ancestral networks at different ages.
#'
