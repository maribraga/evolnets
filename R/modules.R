...
modules_across_ages <- function(summary_networks, tree){
  ...
  # input checking
  if (!is.list(summary_networks) || !all(vapply(summary_networks, inherits, TRUE, 'data.frame'))) {
    stop('`summary_networks` should be a list of data.frames, usually generated by `get_summary_network`.')
  }
