...
`posterior_at_ages( )` finds the parasite lineages that were extant at given time points in the past and calculates the posterior probability for interactions between these parasites and each host.
...
<!-- # get list of incidence matrices -->
<!-- limw <- get_incidence_matrix_at_ages(pp_at_ages, 0.5, weighted = T) -->
<!-- limb <- get_incidence_matrix_at_ages(pp_at_ages, 0.5, weighted = F) -->
...
<!-- # NODF of samples -->
<!-- Nz <- NODF_posterior_at_ages(samples_ages, ages, null = 100, seed = NULL) -->

<!-- # Q of samples -->
<!-- Qz <- Q_posterior_at_ages(samples_ages, ages, null = 10, seed = NULL) -->
